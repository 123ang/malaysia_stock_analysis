  ...
  <div>
    <div class="register container z-depth-1">
      ...
      <div class="field technical_analysis">
        ...
        <v-checkbox
          v-model="technical_analysis"
          label="Below Bonlinger Band"
          value="below_bonlinger_band"
        ></v-checkbox>
        <v-checkbox
          v-model="technical_analysis"
          label="Above Bonlinger Band"
          value="above_bonlinger_band"
        ></v-checkbox>
        <v-checkbox
          v-model="technical_analysis"
          label="Current Price below Than MA 20"
          value="below_ma20"
        ></v-checkbox>
        <v-checkbox
          v-model="technical_analysis"
          label="Current Price Above MA 20"
          value="above_ma20"
        ></v-checkbox>
      </div>
      <div class="field input_field">
        ...
        <v-checkbox
          v-model="candlestick_pattern"
          label="Hammer"
          value="hammer"
        ></v-checkbox>
        <v-checkbox
          v-model="candlestick_pattern"
          label="Inverse Hammer"
          value="inverse_hammer"
        ></v-checkbox>
        <v-checkbox
          v-model="candlestick_pattern"
        ...
        <v-checkbox
          v-model="candlestick_pattern"
          label="Three Black Soldiers"
          value="three_black_soldiers"
        ></v-checkbox>
      </div>
      <div style="text-align: center">
